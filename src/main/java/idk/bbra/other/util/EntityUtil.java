...
import idk.earth.phobos.features.modules.client.Managers;
import idk.earth.phobos.features.modules.combat.Killaura;
import idk.earth.phobos.features.modules.player.Blink;
import idk.earth.phobos.features.modules.player.FakePlayer;
import idk.earth.phobos.features.modules.player.Freecam;
import idk.earth.phobos.mixin.mixins.accessors.IEntityLivingBase;
...
public class EntityUtil implements Util {
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (final EntityPlayer player : mc.world.playerEntities) {
            ...
            output.put(healthSB.toString() + " " + (Phobos.friendManager.isFriend(player) ? "§b" : "§r") + player.getName() + " " + distanceSB.toString() + " " + "§f" + Phobos.totemPopManager.getTotemPopString(player) + Phobos.potionManager.getTextRadarPotion(player), (int) mc.player.getDistance(player));
