...
public class Keybind extends Component {
	...
	public void renderComponent() {
		...
		FontUtils.normal.drawString(binding ? "< PRESS KEY >" : ("Key: " + Keyboard.getKeyName(this.parent.mod.getKey())), (parent.parent.getX() + 7) , (parent.parent.getY() + offset + 2) + 1, -1);
		GL11.glPopMatrix();
	}
	...
	public void keyTyped(char typedChar, int key) {
		...
		else if(this.binding && key == Keyboard.KEY_BACK) {
