package inc.bbra.newclickgui.component.components.sub;
...
import inc.bbra.newclickgui.component.components.Button;
...
public class Slider extends Component {
	...
	public void renderComponent() {
		Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX() + parent.parent.getWidth(), parent.parent.getY() + offset + 12, Cols.LightYellow);
		final int drag = (int)(this.set.getValDouble() / this.set.getMax() * this.parent.parent.getWidth());
		Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX(), parent.parent.getY() + offset + 12, Cols.PurpleOpac);
		...
		Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset + 8, parent.parent.getX() + (int) renderWidth, parent.parent.getY() + offset + 12, hovered ? Cols.LightYellow : Cols.PurpleOpac);
		GL11.glPushMatrix();
		//GL11.glScalef(0.5f,0.5f, 0.5f);
		FontUtils.normal.drawString(this.set.getName() + ": " + this.set.getValDouble() , (parent.parent.getX() + 7), (parent.parent.getY() + offset - 1) + 1, Cols.Purple);
		GL11.glPopMatrix();
	}
