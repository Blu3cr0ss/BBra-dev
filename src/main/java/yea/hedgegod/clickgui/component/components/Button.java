...
import yea.hedgegod.clickgui.component.Frame;
import yea.hedgegod.clickgui.component.components.sub.Checkbox;
import yea.hedgegod.clickgui.component.components.sub.Keybind;

import net.minecraft.client.Minecraft;
import net.minecraft.client.gui.FontRenderer;
import net.minecraft.client.gui.Gui;
import yea.hedgegod.clickgui.component.components.sub.ModeButton;
import yea.hedgegod.clickgui.component.components.sub.Slider;
